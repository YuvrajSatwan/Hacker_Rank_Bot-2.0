...
GOOGLE_CHAT_WEBHOOK_URL = "https://chat.googleapis.com/v1/spaces/AAAAqdu6QBk/messages?key=AIzaSyDdI0hCZtE6vySjMm-WEfRq3CPzqKqqsHI&token=UjAlZTONaFT-V759NSCj15vrUFXZv5n-XRabfoIU65Q"
...
def notify_question_count():
    ...
    if new_questions:
        ...
        notification_templates = [
            ...
            f"⚙️ {len(new_questions)} tests of will arise. 'It’s not who we are underneath, but what we do that defines us.' Let your actions speak.\n\n📌 New Questions:\n{formatted_questions_telegram}",
